<template>
  <h4 class="text-xl w-64 rounded-md bg-gray-300 dark:bg-gray-700">&nbsp;</h4>
  <div
  ...
  >
    <div v-for="index in count" :key="index" class="rounded-md">
      ...
      <div class="w-4/5 h-4 mt-1 rounded-md bg-gray-300 dark:bg-gray-700">&nbsp;</div>
      <div class="w-3/5 h-3.5 mt-1 rounded-md bg-gray-300 dark:bg-gray-700">&nbsp;</div>
    </div>
  </div>
</template>
