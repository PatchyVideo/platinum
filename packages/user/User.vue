...
.btn-default {
  @apply border-gray-400 border-double border-2 bg-white hover:border-gray-600 text-gray-400 hover:text-gray-600;
  @apply dark:bg-opacity-0 dark:border-white dark:hover:border-gray-400 dark:text-white dark:hover:text-gray-400;
}
.password-row {
