<template>
  <div
    ref="NoteBox"
    class="z-50 absolute right-0 top-10 w-80 p-2 rounded overflow-hidden bg-white border border-violet-400 shadow overflow-visible dark:bg-gray-900 dark:border-black"
  >
